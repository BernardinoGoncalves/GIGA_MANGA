...
import sys
from googletrans import Translator # precisa de ser essa versão pip install googletrans==3.1.0a0
...
def TranslateOCR(imglink):
    myfile = "static/img/temp.jpg"

    ## If file exists, delete it ##
    try:
        urllib.request.urlretrieve(imglink, 'static/img/temp.jpg')
        print("Imagem salva! =)")
        # result = recognize_text(myfile)
